      ...
      <footer className="pa2 bg-dark-gray near-white pv5">
        <div className="flex flex-wrap justify-around w-100 mw9 center mb5">
          ...
          <div className="flex flex-column">
            <span className="gold sans-serif f5 tracked mb3 db">
              The Podcast
            </span>
            <Link
              to="/episodes"
              className="ttu near-white sans-serif f5 tracked pv1 db">
              All Episodes
            </Link>
            <Link
              to="/rss.xml"
          ...
          <div className="flex flex-column">
            <span className="gold sans-serif f5 tracked mb3 db">More</span>
            <Link
              to="/about"
              className="ttu near-white sans-serif f5 tracked pv1 db">
              About
        ...
        <div className="w-100 mw9 silver center sans-serif f6">
          <p>Website created and maintained by the Poor People team.</p>
        </div>
      </footer>
    )}
  />
