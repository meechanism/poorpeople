  ...
  <Layout>
    ...
    <div className="lh-copy f4 serif mw8 center">
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for Poor People is
        based on the{' '}
        <a
          className="light-red"
      ...
      <p>
        ...
        our Terms and Conditions, accessible from poorpeoplepodcast.netlify.com
      </p>
      ...
      <p>Poor People uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Poor People will take all steps reasonably necessary to ensure that your
      ...
      <p>
        Poor People may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Poor People</li>
        <li>
      ...
      <ul>
        <li>
          ...
          <p>
            ...
            available to Google Analytics by enabling "Do Not Track" in your
            browser.
          </p>
          <p>
